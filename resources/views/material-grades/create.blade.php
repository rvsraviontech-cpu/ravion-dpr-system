...
<div class="mx-auto max-w-5xl">
    ...
    <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-800">
                Add Material Grade / Rating
            </h1>

            <p class="mt-1 text-gray-500">
                Create a reusable grade or rating for the selected Material Type.
            </p>
        </div>
    ...
    <form method="POST"
          action="{{ route('material-grades.store') }}">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    <label class="{{ $labelClass }}">
                        Grade / Rating <span class="text-red-500">*</span>
                    </label>
                    ...
                    <input type="text"
                           ...
                           class="{{ $inputClass }}"
                           placeholder="Example: 53 Grade, Fe500, 10 kA, SDR 11"
                           required>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="remarks"
                              rows="4"
                              class="{{ $inputClass }}"
                              placeholder="Optional notes about this grade or rating">{{ old('remarks') }}</textarea>
                </div>
