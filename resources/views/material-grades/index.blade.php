...
<div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
    ...
    <div>
        <h1 class="text-3xl font-bold text-gray-800">
            Material Grades / Ratings
        </h1>

        <p class="mt-1 text-gray-500">
            Manage reusable grades and ratings for each Material Type.
        </p>
    </div>

    <a href="{{ route('material-grades.create') }}"
...
<div class="mb-6 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
    ...
    <form method="GET"
          action="{{ route('material-grades.index') }}"
        ...
        <div>
            ...
            <input type="text"
                   ...
                   placeholder="Grade, rating or Material Type"
                   class="{{ $inputClass }}">
        </div>
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('material-grades.index') }}"
...
<div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
    ...
    <div class="overflow-x-auto">
        ...
        <table class="min-w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                @forelse($materialGrades as $index => $grade)

                    <tr class="hover:bg-gray-50">

                        <td class="px-4 py-3">
                            {{ $materialGrades->firstItem() + $index }}
                        </td>

                        <td class="px-4 py-3 whitespace-nowrap">
                            {{ $grade->materialType?->material_group ?? '-' }}
                        </td>

                        <td class="px-4 py-3 font-semibold text-gray-800">
                            {{ $grade->materialType?->material_type_name ?? '-' }}
                        </td>
                        ...
                        <td class="px-4 py-3 text-center">
                            {{ $grade->materialType?->unit?->unit_name ?? '-' }}
                        </td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="flex flex-wrap justify-center gap-2">
                                ...
                                <form method="POST"
                                    ...
                                    <button type="submit"
                                            onclick="return confirm('Change this grade/rating status?')"
                ...
                @empty
                    ...
                    <tr>
                        <td colspan="9"
                            ...
                            No material grades or ratings found.
                        </td>
                    </tr>
    ...
    @if($materialGrades->hasPages())
        <div class="border-t border-gray-200 px-4 py-4">
            {{ $materialGrades->links() }}
        </div>
    @endif
