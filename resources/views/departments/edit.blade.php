    ...
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Update department master details.
            </p>
        </div>
            ...
            <div class="grid grid-cols-1 gap-4 p-5 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="remarks"
                              ...
                              class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 outline-none transition focus:border-gray-500 focus:ring-2 focus:ring-gray-200">{{ old('remarks', $department->remarks) }}</textarea>
                </div>
