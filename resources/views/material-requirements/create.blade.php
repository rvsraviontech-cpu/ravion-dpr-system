    ...
    <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
            ...
            <p class="mt-1 text-gray-500">
                Create one requirement containing one or more materials for procurement and planning.
            </p>
        </div>
    ...
    <form method="POST"
        ...
        <div class="mb-6 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
            ...
            <div class="mb-5 rounded-xl bg-[#0F2A52] px-4 py-3 text-white">
                ...
                <p class="mt-1 text-xs text-blue-100">Select the project, block, required date and priority.</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div>
                    ...
                    <input type="date"
                           name="required_date"
                           value="{{ old('required_date', now()->format('Y-m-d')) }}"
                           class="{{ $inputClass }}">
                </div>
                ...
                <div class="md:col-span-2 xl:col-span-4">
                    ...
                    <textarea name="remarks"
                              rows="3"
                              class="{{ $inputClass }}"
                              placeholder="General notes for this material requirement">{{ old('remarks') }}</textarea>
                </div>
            ...
            <div class="flex flex-col gap-3 border-b border-gray-200 bg-[#0F2A52] p-4 text-white md:flex-row md:items-center md:justify-between md:p-5">
                <div>
                    ...
                    <p class="mt-1 text-xs text-blue-100 sm:text-sm">
                        Add all materials required under this request.
                    </p>
                </div>
                            ...
                            <tr class="material-item-row block overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm lg:table-row lg:rounded-none lg:border-0 lg:shadow-none"
                                ...
                                <td class="block bg-slate-50 px-3 py-3 lg:table-cell lg:bg-transparent lg:text-center">
                                    <div class="flex items-center justify-between lg:block">
                                        ...
                                        <span class="row-number inline-flex h-7 min-w-7 items-center justify-center rounded-full bg-blue-100 px-2 text-xs font-bold text-blue-800 lg:bg-transparent lg:text-sm lg:text-inherit">{{ $loop->iteration }}</span>
                                    </div>
                                </td>
                                ...
                                <td data-mobile-label="Required Qty" class="block px-3 py-3 before:mb-1 before:block before:text-[10px] before:font-bold before:uppercase before:tracking-wide before:text-gray-500 before:content-[attr(data-mobile-label)] lg:table-cell lg:before:hidden">
                                    <input type="number"
                                           ...
                                           value="{{ $oldItem['required_quantity'] ?? '' }}"
                                           class="{{ $inputClass }}"
                                           required>
                                </td>
