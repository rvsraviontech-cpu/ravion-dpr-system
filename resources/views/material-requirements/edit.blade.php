    ...
    <form method="POST"
        ...
        <div class="mb-6 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
            <div class="mb-5 rounded-xl bg-[#0F2A52] px-4 py-3 text-white">
                <h2 class="text-lg font-bold sm:text-xl">Requirement Information</h2>
                <p class="mt-1 text-xs text-blue-100">Update project, required date and priority.</p>
            </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="overflow-visible lg:overflow-x-auto">
                ...
                <table class="block w-full text-sm lg:table lg:min-w-[1850px]">
                            ...
                            <tr class="material-item-row block overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm lg:table-row lg:rounded-none lg:border-0 lg:shadow-none"
                                ...
                                <td class="block bg-slate-50 px-3 py-3 lg:table-cell lg:bg-transparent lg:text-center">
                                    <div class="flex items-center justify-between lg:block">
                                        <span class="text-xs font-bold uppercase tracking-wide text-gray-500 lg:hidden">Requirement Item</span>
                                ...
                                <td data-mobile-label="Material" class="block px-3 py-3 before:mb-1 before:block before:text-[10px] before:font-bold before:uppercase before:tracking-wide before:text-gray-500 before:content-[attr(data-mobile-label)] lg:table-cell lg:before:hidden">
                                ...
                                <td data-mobile-label="Required Qty" class="block px-3 py-3 before:mb-1 before:block before:text-[10px] before:font-bold before:uppercase before:tracking-wide before:text-gray-500 before:content-[attr(data-mobile-label)] lg:table-cell lg:before:hidden">
                                    <input type="number"
                                           step="0.001"
                                           min="0.001"
                                ...
                                <td data-mobile-label="Fulfilled Qty" class="block px-3 py-3 before:mb-1 before:block before:text-[10px] before:font-bold before:uppercase before:tracking-wide before:text-gray-500 before:content-[attr(data-mobile-label)] lg:table-cell lg:before:hidden">
                                    <input type="number"
                                           step="0.001"
                                           min="0"
