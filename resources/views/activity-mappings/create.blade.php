...
<div class="bg-white p-6 rounded shadow">
    ...
    <form method="POST"
          action="{{ route('activity-mappings.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text"
                       name="rh_cost_code"
                       value="{{ old('rh_cost_code') }}"
                       placeholder="Example: RH-25-01-001"
            ...
            <div>
                ...
                <input type="text"
                       name="inventory_expense_bucket"
                       value="{{ old('inventory_expense_bucket') }}"
                       class="border p-2 rounded w-full">
            </div>
