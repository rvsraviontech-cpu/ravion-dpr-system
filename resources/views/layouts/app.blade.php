...
<div class="min-h-screen bg-gray-100">
    ...
    <aside class="fixed left-0 top-0 w-64 min-w-64 h-screen bg-gray-900 text-white overflow-y-auto z-30">
        ...
        <ul class="py-4 space-y-1">
            ...
            @if($can('dashboard.view') || $can('engineer_dashboard.view') || $can('dashboard.executive') || $can('project_health_dashboard.view') || $can('pmo_exception_dashboard.view'))
                <li class="px-4 py-2 text-xs font-bold text-gray-400 uppercase">
                    Dashboards
                </li>
                ...
                @if($can('engineer_dashboard.view'))
                    <li>{!! $sidebarLink('engineer-dashboard', 'Dashboard') !!}</li>
                @endif
            ...
            @if(
                ...
                <li class="px-4 py-3 text-xs font-bold text-gray-400 uppercase">
                    Daily Execution
                </li>
            ...
            @if($can('tomorrow_plans.view') || $can('weekly_plans.view') || $can('monthly_plans.view') || $can('plan_vs_actual.view') || $can('activity_progress.view'))
                <li class="px-4 py-3 text-xs font-bold text-gray-400 uppercase">
                    Planning & Controls
                </li>
            ...
            @if(
                ...
                @if($can('materials.view'))<li>{!! $sidebarLink('unit-masters.index', 'Unit Masters') !!}</li>
@endif
            @endif
            ...
            @if($can('location_masters.view'))
                ...
                <li>{!! $sidebarLink('project-locations.index', 'Project Locations') !!}</li>
            ...
            @if($can('users.view') || $can('roles.view') || $can('permissions.view') || $can('role_permissions.view') || $can('audit_trail.view'))
                <li class="px-4 py-3 text-xs font-bold text-gray-400 uppercase">
                    Administration
                </li>
                ...
                @if($can('audit_trail.view')) <li>{!! $sidebarLink('audit-logs.index', 'Audit Trail') !!}</li> @endif
            @endif
