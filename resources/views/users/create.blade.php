    ...
    <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Create an ERP user and assign role, department, designation and optional project access.
            </p>
        </div>
    ...
    <form method="POST"
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="border-b border-gray-200 bg-gray-50 px-5 py-3">
                <h2 class="text-sm font-semibold text-gray-900">Employee Information</h2>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="border-b border-gray-200 bg-gray-50 px-5 py-3">
                ...
                <p class="mt-0.5 text-xs text-gray-500">
                    Role is required. Project assignment is optional and can also be managed later from the Projects module.
                </p>
            </div>
                    ...
                    <div>
                        ...
                        <select name="project_access_scope"
                            ...
                            <option value="selected"
                                {{ old('project_access_scope', 'selected') === 'selected' ? 'selected' : '' }}>
                                Selected Projects
                            </option>

                            <option value="all"
                                {{ old('project_access_scope') === 'all' ? 'selected' : '' }}>
                                All Projects
                            </option>
                        </select>
                        ...
                        @forelse($projects as $project)
                            ...
                            <label class="flex cursor-pointer items-start gap-3 border-b border-gray-100 px-4 py-3 transition last:border-b-0 hover:bg-gray-50">
                                ...
                                <input type="checkbox"
                                       ...
                                       {{ in_array(
                                            (int) $project->id,
                                            array_map('intval', old('project_ids', [])),
                                            true
                                       ) ? 'checked' : '' }}>
        ...
        <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="border-b border-gray-200 bg-gray-50 px-5 py-3">
                <h2 class="text-sm font-semibold text-gray-900">Login Credentials</h2>
                <p class="mt-0.5 text-xs text-gray-500">
                    Create the user's initial password.
                </p>
            </div>
                ...
                <div class="md:col-span-2">
                    <label class="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
                        ...
                        <div>
                            ...
                            <div class="mt-0.5 text-xs text-gray-500">
                                Recommended when issuing a temporary password to a new employee.
                            </div>
                        </div>
...
<script>
    ...
    const previousDesignationId = @json((string) old('employee_designation_id', ''));
    ...
    function filterDesignations() {
        ...
        designations.forEach(function (designation) {
            ...
            if (String(designation.id) === String(previousDesignationId)) {
