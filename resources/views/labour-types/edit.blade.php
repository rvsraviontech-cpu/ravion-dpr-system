...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-500 mt-1">
                Update labour type and its category.
            </p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <form action="{{ route('labour-types.update', $labourType) }}"
              method="POST">
                ...
                <select name="labour_category_id"
                    ...
                    @foreach($labourCategories as $category)
                        <option value="{{ $category->id }}"
                            {{ old('labour_category_id', $labourType->labour_category_id) == $category->id ? 'selected' : '' }}>
            ...
            <div class="mb-6">
                ...
                <input type="text"
                       ...
                       value="{{ old('labour_type_name', $labourType->labour_type_name) }}"
                       class="w-full border rounded-lg p-3 focus:ring-2 focus:ring-blue-500"
                       required>
            </div>
