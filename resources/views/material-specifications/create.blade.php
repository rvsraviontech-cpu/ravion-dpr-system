...
<div class="mx-auto max-w-5xl">
    ...
    <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div>
            ...
            <p class="mt-1 text-gray-500">
                Create a reusable specification for the selected Material Type.
            </p>
        </div>
    ...
    <form method="POST"
          action="{{ route('material-specifications.store') }}">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           value="{{ old('specification_name') }}"
                           class="{{ $inputClass }}"
                           placeholder="Example: PPC, OPC, 12 MM, 25 MM"
                           required>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="remarks"
                              rows="4"
                              class="{{ $inputClass }}"
                              placeholder="Optional notes about this specification">{{ old('remarks') }}</textarea>
                </div>
