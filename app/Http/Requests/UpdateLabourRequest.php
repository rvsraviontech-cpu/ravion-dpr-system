...
class UpdateLabourRequest extends FormRequest
{
    ...
    /**
     * Validation rules for updating a labour profile.
     */
    public function rules(): array
    {
        ...
        return [
            ...
            */
            ...
            /*
             * The visible Skill Category is informational.
             * The controller derives the saved value from
             * designation_roles.skill_category_id.
             */
            'skill_category_id' => [
                'nullable',
                'integer',
    ...
    /**
     * Resolve the current Labour model from route binding.
     */
    public function labour(): ?Labour
    {
        $labour = $this->route('labour');

        return $labour instanceof Labour
            ? $labour
            : null;
    }
}